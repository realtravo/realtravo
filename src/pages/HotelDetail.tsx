      ...
      <main className="container px-4 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[1.7fr,1fr] gap-6">
          <div className="flex flex-col gap-6">
            ...
            {/* Price Card for Mobile (Appears below description on small screens) */}
...
const PriceCard = ({ place, liveRating, navigate }: any) => {
  // Logic to handle working days (assumes array or comma-separated string)
  const workingDays = Array.isArray(place.working_days) 
    ? place.working_days 
    : place.working_days?.split(',').filter(Boolean) || ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"];
    ...
    <div className="bg-white rounded-[32px] p-8 shadow-2xl border border-slate-100">
      ...
      <div className="space-y-4 mb-8">
        <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
          ...
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">Operating Hours</p>
