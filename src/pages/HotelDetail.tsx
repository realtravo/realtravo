  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pb-24">
      ...
      <main className="container px-4 max-w-6xl mx-auto pt-0 relative z-50">
        ...
        {/* HERO SECTION - Sharp top, Bottom rounded, object-center */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.8fr,1fr] gap-6">
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-[32px] p-8 shadow-xl border border-slate-100 lg:hidden">
              ...
              <OperatingHoursInfo />
              <Button onClick={() => navigate(`/booking/hotel/${hotel.id}`)} className="w-full mt-6 py-8 rounded-2xl text-md font-black uppercase tracking-widest bg-gradient-to-r from-[#FF7F50] to-[#FF4E50] border-none shadow-lg transition-all active:scale-95 text-white">Book Now</Button>
          ...
          <div className="hidden lg:block h-fit sticky top-24">
            <div className="bg-white rounded-[40px] p-8 shadow-2xl border border-slate-100 space-y-6">
                ...
                <OperatingHoursInfo />
                <Button onClick={() => setBookingOpen(true)} className="w-full py-8 rounded-3xl text-lg font-black uppercase tracking-widest bg-gradient-to-r from-[#FF7F50] to-[#FF4E50] border-none shadow-xl hover:scale-[1.02] transition-transform active:scale-95 text-white">Reserve Now</Button>
